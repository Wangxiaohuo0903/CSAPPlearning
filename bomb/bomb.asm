...
0000000000400bf0 <__isoc99_sscanf@plt>:
  ...
  400bf6:	68 11 00 00 00       	pushq  $0x11        //17
...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)              //check a[0]==1?
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax       //eax=
  400f1a:	01 c0                	add    %eax,%eax              //eax=2*a[0]
  400f1c:	39 03                	cmp    %eax,(%rbx)            //check a[1]==2*a[0]
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx              //rbx+=4
  400f29:	48 39 eb             	cmp    %rbp,%rbx              //check rbp!=rbx?
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax  //edx=14
  ...
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> //tiao
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx          //rbx=a
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx    //ecx=a[0] ASCII
  40108f:	88 0c 24             	mov    %cl,(%rsp)            //cl=6 

  401092:	48 8b 14 24          	mov    (%rsp),%rdx            /rdx=a[0] ASCII
  401096:	83 e2 0f             	and    $0xf,%edx                  edx=a[0]&&0x1111
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx      /1\024@
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)   //rsp+rax+8
  4010a4:	48 83 c0 01          	add    $0x1,%rax                  
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi    //flyers
...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14   //r14=&a[0]
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax  //eax=a[1]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)       //a[0]!=a[x]
  ...
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx  //rdx+=8*(6-a[0])
  40117a:	83 c0 01             	add    $0x1,%eax    //eax=1,eax+1 ecx=7-a[0]
  ...
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx  //ecx=7-a[0]
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax           //eax=1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx    rbx=&b[0]  &b[1]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax    rax=0      &&b[0]  
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi    rsi=&&b[6]
  4011ba:	48 89 d9             	mov    %rbx,%rcx          rcx=&b[0]   &b[1]
  4011bd:	48 8b 10             	mov    (%rax),%rdx        rdx=&b[1]  rdx=&b[2]
  4011c0:	48 89 51           	mov    %rdx,0x8(%rcx)     
  4011c4:	48 83 c0 08          	add    $0x8,%rax          rax=&b[2]
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx          rcx=b[1]
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax  rax=&b[1]
  4011e3:	8b 00                	mov    (%rax),%eax   eax=b[1]
  4011e5:	39 03                	cmp    %eax,(%rbx)  b[0]>b[1]
...
0000000000401204 <fun7>:target eax=2
  401204:	48 83 ec 08          	sub    $0x8,%rsp
  401208:	48 85 ff             	test   %rdi,%rdi          !  // esi input
  40120b:	74 2b                	je     401238 <fun7+0x34>  ! //check rdi=0?
  40120d:	8b 17                	mov    (%rdi),%edx   //36
  40120f:	39 f2                	cmp    %esi,%edx    //check >36 16 
  401211:	7e 0d                	jle    401220 <fun7+0x1c>    //edx<esi
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax      //eax initial=0
  ...
  401241:	c3                   	retq   
rdi==NULL ->return -1
rdi>input    rdi->1 return 2*fun7
rdi =input     return 0
rdi <input rdi->2 return 2*eax+1 
rax=19
> < < <
> < =
0000000000401242 <secret_phase>:
  ...
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax      //check
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi      a[0]
...
000000000040145c <read_six_numbers>:
  ...
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax  //rax=20+rsi
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)    //local var2=rax
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax    //rax=rsi+16
  401474:	48 89 04 24          	mov    %rax,(%rsp)        //local var1=rax=rsi+16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9      //r9=rsi+12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8      //r8=rsi+8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi       //esi=0x4025
  401485:	b8 00 00 00 00       	mov    $0x0,%eax            //eax=0
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax            //check 5>eax?
...
00000000004015c4 <phase_defused>:
  ...
  4015e1:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8 //1   4 3 2 1 6 5
  4015e6:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx //6
  4015eb:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx //5
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi &%d %d %s
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi &"7 0"
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax   //"2"
